...
public abstract class ServerAppliance {
   ...
   public static ServerAppliance create(String id, String name, List<String> availableDataCenters, String osInstallationBase, Types.OSFamliyType osFamily, String os,
           String osVersion, int osArchitecture, Types.OSImageType osImageType, int minHddSize, ApplianceType type, String state, String version, List<String> serverTypeCompatibility,
           List<String> categories) {
      return new AutoValue_ServerAppliance(id, name, availableDataCenters == null ? ImmutableList.<String>of() : ImmutableList.copyOf(availableDataCenters), osInstallationBase, osFamily, os, osVersion, osArchitecture, osImageType, minHddSize, type, state, version, serverTypeCompatibility == null ? ImmutableList.<String>of() : ImmutableList.copyOf(serverTypeCompatibility), categories == null ? ImmutableList.<String>of() : ImmutableList.copyOf(categories));
   }

...
public abstract class SingleServerAppliance {
   ...
   @Nullable
   public abstract List<Types.ServerTypeCompatibility> serverTypeCompatibility();
   ...
   public static SingleServerAppliance create(String id, String name, List<String> availableDataCenters, String osInstallationBase, Types.OSFamliyType osFamily, String os,
           String osVersion, int osArchitecture, Types.OSImageType osImageType, Integer minHddSize, Types.ApplianceType type, String state, String version, List<String> categories, List<Types.ServerTypeCompatibility> serverTypeCompatibility) {
      return builder()
              .id(id)
              .name(name)
              ...
              .serverTypeCompatibility(serverTypeCompatibility == null ? ImmutableList.<Types.ServerTypeCompatibility>of() : ImmutableList.copyOf(serverTypeCompatibility))
              .build();
   }
   ...
   public abstract static class Builder {
      ...
      public abstract Builder serverTypeCompatibility(List<Types.ServerTypeCompatibility> serverTypeCompatibility);

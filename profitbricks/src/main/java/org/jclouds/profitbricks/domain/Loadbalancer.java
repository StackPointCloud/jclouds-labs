...
public abstract class Loadbalancer {
    ...
    public static Loadbalancer create(String id, String name, LoadbalancerAlgorithm loadBalancerAlgorithm,
            ...
            String ip, String lanId, ProvisioningState state, Date creationTime, Date lastModificationTime, List<BalancedServer> balancedServers, List<Firewall> firewalls) {
        return new AutoValue_Loadbalancer(id, name, loadBalancerAlgorithm, dataCenterId, dataCenterVersion, internetAccess, ip, lanId, state, creationTime, lastModificationTime, balancedServers, firewalls);
    }

...
public class DataCenterToLocation implements Function<DataCenter, Location> {
   ...
   @Inject
   DataCenterToLocation(Function<org.apache.jclouds.profitbricks.rest.domain.Location, Location> fnRegion) {
   ...
   public Location apply(DataCenter dataCenter) {
      ...
      if (dataCenter.properties().location() != null)
         builder.parent(fnRegion.apply(dataCenter.properties().location()));

...
public class ServerInDataCenterToNodeMetadataTest extends BaseProfitBricksApiMockTest {
    ...
    public void setup() {
        ...
        this.fnNodeMetadata = new ServerInDataCenterToNodeMetadata(new VolumeToVolume(), locationsSupply, namingConvention);
    }
    ...
    public void testServerInDataCenterToNodeMetadata() {
        ...
        Server serverObject = api.serverApi().getServer("datacenter-id", "some-id");

        ServerInDataCenter server = new ServerInDataCenter(serverObject, "datacenter-id");
